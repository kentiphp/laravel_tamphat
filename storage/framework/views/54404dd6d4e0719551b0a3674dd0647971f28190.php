                ...
                <form action="<?php echo e(route('export.store')); ?>" method="POST" class="form-horizontal" id="createMainForm">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select onchange="getCustomer(this.value)" class="select2" id="customer_code" name="customer_code" style="width: 100%;">
                                    <option>~~~~ Chọn Nhà Phân Phối ~~~~</option>
                                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($customer->code); ?>"><?php echo e($customer->name); ?> - <?php echo e($customer->orders_count); ?> đơn hàng</option>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-2">
                                <button type="button" onclick="getCommodities($('#customer_code').val())" class="btn bg-purple" data-toggle="modal" data-target="#addCommodity">+</button>
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        ...
                        <button value="<?php echo e(__('import.submit')); ?>" type="submit" class="btn btn-info pull-right">Thêm mới</button>
                    </div>
                    <!-- /.box-footer -->
                </form>
            </div>
