                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<?php echo e(asset('img/user4-128x128.jpg')); ?>" class="img-circle"
                                                 alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<?php echo e(asset('img/user3-128x128.jpg')); ?>" class="img-circle"
                                                 alt="User Image">
                                        </div>
                                        <h4>
                                            Sales Department
...
<aside class="main-sidebar">
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\Program Files (x86)\Ampps\www\tamcute\resources\views/components/menu.blade.php ENDPATH**/ ?>