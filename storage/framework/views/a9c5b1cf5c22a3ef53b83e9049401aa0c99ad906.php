                            ...
                            <div class="col-sm-10">
                                <select onchange="getSupplier(this.value)" class="select2" id="supplier_code" name="supplier_code" style="width: 100%;">
                                    ...
                                    <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($supplier->code); ?>"><?php echo e($supplier->name); ?> - <?php echo e($supplier->commodities_count); ?> sản phẩm</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files (x86)\Ampps\www\tamcute\resources\views/import/create.blade.php ENDPATH**/ ?>